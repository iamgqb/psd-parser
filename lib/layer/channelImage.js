...
function mergeImageData(layer, colorMode){
    return Mode[colorMode](layer)
}
...
//console.log(channel.data)
    ...
    layer.pixelData = mergeImageData(layer, colorMode);
