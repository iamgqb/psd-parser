...
var mask = require('./mask'),
    blendingRange = require('./blendingRange'),
    addLayerInfo = require('./addLayerInfo');
...
//        o.data //TODO channel data handle, now seek
//        file.seek(o.length);
        channelInfo.push(o);
    }
    ...
    var layerMaskData = mask(file);
    var blendingRangesData = blendingRange(file);

    var nameLength = file.pad4(file.readByte())-1,
        name = file.readString(nameLength);

    var additional = addLayerInfo(file, endPos);
